...
it('ExpertCard: displays', () => {
  const component = shallow(<ExpertCard />)
  expect(component.length).toBe(1)
})

it('ExpertCard: title text displays if provided', () => {
  const component = shallow(<ExpertCard name="Paul Fidalgo" />)
